...
prompt Created by Yoav on Tuesday, 11 June 2024
set feedback off
set define off
...
alter table COMBAT_MEDIC disable constraint SYS_C008771;
prompt Disabling foreign key constraints for COMMANDER...
alter table COMMANDER disable constraint SYS_C008776;
prompt Disabling foreign key constraints for MILITARY_RABBI...
alter table MILITARY_RABBI disable constraint SYS_C008788;
prompt Disabling foreign key constraints for TEAM...
alter table TEAM disable constraint SYS_C008794;
prompt Disabling foreign key constraints for OPERATION...
alter table OPERATION disable constraint SYS_C008818;
alter table OPERATION disable constraint SYS_C008819;
alter table OPERATION disable constraint SYS_C008820;
prompt Disabling foreign key constraints for SOLIDER_IN...
alter table SOLIDER_IN disable constraint SYS_C008809;
alter table SOLIDER_IN disable constraint SYS_C008810;
...
insert into SOLIDER (date_of_birth, id, first_name, rank, religion, last_name)
values (to_date('30-12-1993', 'dd-mm-yyyy'), 585, 'ChantÃƒÂ©', 'Colonel', 'Islam', 'Diesel');
insert into SOLIDER (date_of_birth, id, first_name, rank, religion, last_name)
...
insert into TEAM (team_number, name, religious, commander_id)
values (203, 'ThÃƒÂ¶rishaus', 1, 603);
insert into TEAM (team_number, name, religious, commander_id)
...
insert into TEAM (team_number, name, religious, commander_id)
values (270, 'MÃƒÂ¶nchengladbach', 0, 670);
insert into TEAM (team_number, name, religious, commander_id)
...
insert into TEAM (team_number, name, religious, commander_id)
values (330, 'Santana do parnaÃƒÂ­ba', 1, 730);
insert into TEAM (team_number, name, religious, commander_id)
...
insert into TEAM (team_number, name, religious, commander_id)
values (339, 'MÃƒÂ¶nchengladbach', 0, 739);
insert into TEAM (team_number, name, religious, commander_id)
...
insert into TEAM (team_number, name, religious, commander_id)
values (385, 'VisselhÃƒÂ¶vede', 0, 785);
insert into TEAM (team_number, name, religious, commander_id)
...
alter table COMBAT_MEDIC enable constraint SYS_C008771;
prompt Enabling foreign key constraints for COMMANDER...
alter table COMMANDER enable constraint SYS_C008776;
prompt Enabling foreign key constraints for MILITARY_RABBI...
alter table MILITARY_RABBI enable constraint SYS_C008788;
prompt Enabling foreign key constraints for TEAM...
alter table TEAM enable constraint SYS_C008794;
prompt Enabling foreign key constraints for OPERATION...
alter table OPERATION enable constraint SYS_C008818;
alter table OPERATION enable constraint SYS_C008819;
alter table OPERATION enable constraint SYS_C008820;
prompt Enabling foreign key constraints for SOLIDER_IN...
alter table SOLIDER_IN enable constraint SYS_C008809;
alter table SOLIDER_IN enable constraint SYS_C008810;
